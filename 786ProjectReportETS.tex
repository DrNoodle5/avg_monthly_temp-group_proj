...
{\centering \includegraphics[width=1\linewidth]{figure/data-cleaning-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/eda-plots-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/arima-models-transformations-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/ets-assumptions-1} 
...
\hldef{best_arima} \hlopt{%>%}
  \hlkwd{gg_tsresiduals}\hldef{(}\hlkwc{lag_max} \hldef{=} \hlnum{36}\hldef{)}
\end{alltt}
\end{kframe}\begin{figure}[H]

{\centering \includegraphics[width=1\linewidth]{figure/arima-assumptions-1} 

}

\caption[Residual Diagnostics for ARIMA Model]{Residual Diagnostics for ARIMA Model}\label{fig:arima-assumptions}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figure/assumption-checking-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/ets-forecasting-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/arima-forecasting-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/forecasting-1} 
...
{\centering \includegraphics[width=1\linewidth]{figure/forecasting-combined-1} 
